...
namespace Ongar.Messaging.TCP
{
    public class Server
    {
        ...
        public Server Start(int port, bool ignoreNicsWithOccupiedPorts = true)
        {
        ...
        public Server Start(int port, AddressFamily addressFamilyFilter)
        {
        ...
        public Server Start(IPAddress ipAddress, int port)
        {
